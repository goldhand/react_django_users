...
This will run all tests in the [`./react_django_users/static/react_django_users/__tests__`][test-dir] directory.
...
Open the lcov-report for an overview of your code coverage:
    ...
    $ open react_django_users/static/react_django_users/dist//reports/coverage/lcov-report/index.html
...
#### Source `./react_django_users/static/react_django_users/`
Main project source.

#### Actions `./react_django_users/static/react_django_users/actions/`
...
#### Components `./react_django_users/static/react_django_users/components/`
React components. Mostly __dumb__ components.

#### Constants `./react_django_users/static/react_django_users/constants/`
Stuff that doesn't change. Redux action types.

#### Containers `./react_django_users/static/react_django_users/containers/`
...
#### Reducers `./react_django_users/static/react_django_users/reducers/`
Reducer functions that take in the _current state_ and an _action type_ then return a new state.

#### Store `./react_django_users/static/react_django_users/store/`
...
[test-dir]: /react_django_users/static/react_django_users/__tests__/
